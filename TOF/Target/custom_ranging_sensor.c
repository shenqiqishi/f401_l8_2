...
static const CUSTOM_RANGING_HwConfig_t CUSTOM_RANGING_HwConfig[CUSTOM_RANGING_INSTANCES_NBR] =
{
  ...
  {
    CUSTOM_VL53L8CX_2_PWR_EN_PORT,
    CUSTOM_VL53L8CX_2_PWR_EN_PIN,
    CUSTOM_VL53L8CX_2_LPn_PORT,
    CUSTOM_VL53L8CX_2_LPn_PIN,
    (uint16_t)(CUSTOM_VL53L8CX_DEFAULT_ADDRESS + (3U * CUSTOM_VL53L8CX_ADDRESS_STEP))
  },
#endif
};
